...
EVENT_CATALOG: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "description": "An external pipeline began.",
    },
    {
        ...
        "description": "An external pipeline finished in a room.",
    },
    {
        "id": "workflow.failed",
        "family": "workflow",
        ...
        "description": "An external pipeline failed.",
    },
    {
        ...
        "description": "The dispatch layer ingested an alert.",
    },
]
IN_EVENTS = tuple(
