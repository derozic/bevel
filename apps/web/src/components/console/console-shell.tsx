...
const navigation: NavigationItem[] = [
  ...
  { name: "MCP", href: "/console/integrations?lane=mcp", icon: Sparkles, shortcut: "⌘M" },
...
export function ConsoleShell({
  ...
  const onApex = chatHref === '/me' || chatHref.endsWith('/me');
  const chatLabel = onApex ? 'Open Private' : 'Back to chat';
  const chatHint = onApex
    ? 'Private is you + agents. Console is settings only.'
  ...
  useEffect(() => {
    const handleKeyPress = (e: KeyboardEvent) => {
      ...
      switch (e.key) {
        ...
        case "M":
          e.preventDefault();
          softGo("/console/integrations?lane=mcp");
          break;
        case "a":
        case "A":
          e.preventDefault();
        ...
        <div className="flex items-center justify-between h-14 px-4">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            >
              ...
              <span className="sm:hidden">{onApex ? 'Private' : 'Chat'}</span>
            </a>
          </div>
            ...
            >
              ...
              <div className="p-4 pb-2">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-semibold">{chatLabel}</span>
                  </div>
              ...
              <nav className="p-4 pt-2 space-y-1">
                {navigation.map((item) => {
                  ...
                  const isActive = item.href.includes("lane=mcp")
                    ? pathname === "/console/integrations" && lane === "mcp"
              ...
              <div className="p-4 border-t border-border">
                ...
                <div className="space-y-1 text-xs">
                  <div className="flex justify-between">
                    <span className="text-text-muted">{chatLabel}</span>
