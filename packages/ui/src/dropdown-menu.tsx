...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && 'pl-8',
      destructive &&
        'text-red-600 focus:bg-red-500/10 focus:text-red-700 dark:text-red-400 dark:focus:text-red-300',
      className,
    )}
    {...props}
  />
    ...
    <span className="absolute left-2.5 flex size-3.5 items-center justify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <svg viewBox="0 0 16 16" className="size-3.5 fill-current" aria-hidden>
          <path d="M6.5 11.2 3.3 8l1.1-1.1 2.1 2.1 5.1-5.1L12.7 5 6.5 11.2z" />
        </svg>
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
...
export const DropdownMenuShortcut = ({
  ...
  <span
    className={cn('ml-auto text-[10px] tracking-widest text-muted', className)}
    {...props}
  />
)
...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    ...
    <svg
      ...
      aria-hidden
    >
      <path d="M6.2 3.5 10.7 8 6.2 12.5 5.1 11.4 8.5 8 5.1 4.6z" />
    </svg>
  </DropdownMenuPrimitive.SubTrigger>
))
